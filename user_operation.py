...
# Form implementation generated from reading ui file 'user_operation.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_book.setGeometry(QtCore.QRect(170, 390, 101, 32))
        ...
        self.widget.setGeometry(QtCore.QRect(530, 20, 121, 131))
        ...
        self.btn_passengers = QtWidgets.QPushButton(self.widget)
        self.btn_passengers.setObjectName("btn_passengers")
        self.verticalLayout_5.addWidget(self.btn_passengers)
        self.btn_orders = QtWidgets.QPushButton(self.widget)
        self.btn_orders.setObjectName("btn_orders")
        self.verticalLayout_5.addWidget(self.btn_orders)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_book.setText(_translate("MainWindow", "订购"))
        ...
        self.label_6.setText(_translate("MainWindow", "个人中心"))
        self.btn_info.setText(_translate("MainWindow", "信息管理"))
        self.btn_passengers.setText(_translate("MainWindow", "乘机人管理"))
        self.btn_orders.setText(_translate("MainWindow", "订单管理"))
